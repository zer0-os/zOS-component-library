...
describe('image', () => {
  describe('getSourceUrl', () => {
    it('it returns url directly if no query string', function() {
      const result = getSourceUrl('https://donkeys.com/image.jpg');
    ...
    it('it returns url directly if query string and no zer0ImageCrop', function() {
      const result = getSourceUrl('https://donkeys.com/image.jpg?bla=true');
    ...
    it('it returns url without zer0ImageCrop', function() {
      [
        ['https://donkeys.com/image.jpg?__zer0ImageCrop__=something', 'https://donkeys.com/image.jpg'],
        ['https://d.com/i.jpg?__zer0ImageCrop__=something&eggs=cool', 'https://d.com/i.jpg?eggs=cool'],
        ['https://d.com/i.jpg?eggs=awesome&__zer0ImageCrop__=something', 'https://d.com/i.jpg?eggs=awesome'],
        ['https://d.com/i.jpg?eggs=awesome&__zer0ImageCrop__=something&fish=something', 'https://d.com/i.jpg?eggs=awesome&fish=something'],
      ].forEach(expectation => {
       expect(getSourceUrl(expectation[0])).toEqual(expectation[1]);
      })
    });
  });
  ...
  describe('getSource', () => {
    ...
    it('it returns source directly if local', function() {
      const result = getSource({ src: 'eggs.jpg', local: true, options: {} });

      expect(result).toEqual('eggs.jpg');
    });

    it('it returns url with fetch type if not cloudinary url', function() {
      const result = getSource({ src: 'https://images.com/myimage.jpg', options: {} });
